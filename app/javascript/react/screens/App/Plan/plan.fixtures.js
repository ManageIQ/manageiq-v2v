...
export const planRequestsResult = Immutable({
  ...
  miq_request_tasks: [
    ...
    {
      created_on: '2018-04-08T12:31:30Z',
      description: 'Transforming VM [test_migration]',
      destination_id: null,
      destination_type: null,
      href: 'https://miq.example.com/api/request_tasks/18',
      ...
      options: {
        cart_state: 'ordered',
        collapse_snapshots: true,
        delivered_on: '2018-04-08T12:31:30.871Z',
        destination_vm_id: '48',
        dialog: null,
        export_domain_id: '1',
        initiator: null,
        ...
        progress: {
          ...
          states: {
            '/State1': {
              ...
              message: 'State1 is finished.',
              percent: 100.0,
              started_on: '2018-04-08T12:31:52Z',
              status: 'finished',
              updated_on: '2018-04-08T12:32:28Z',
              weight: 1
            },
            '/State2': {
              description: 'Acquire Transformation Host',
              message: 'State2 is finished.',
              percent: 100.0,
              started_on: '2018-04-08T12:32:44Z',
              status: 'finished',
              updated_on: '2018-04-08T12:33:20Z',
              weight: 1
            },
            '/State3': {
              description: 'Power off',
              message: 'State3 is finished.',
              percent: 100.0,
              started_on: '2018-04-08T12:33:35Z',
              status: 'finished',
              updated_on: '2018-04-08T12:34:06Z',
              weight: 1
            },
            '/State4': {
              description: 'Collapse Snapshots',
              message: 'State4 is finished.',
              percent: 100.0,
              started_on: '2018-04-08T12:34:22Z',
              status: 'finished',
              updated_on: '2018-04-08T12:34:53Z',
              weight: 1
            },
            '/State5': {
              description: 'Transform VM',
              message: 'State5 is finished.',
              percent: 100.0,
              started_on: '2018-04-08T12:35:09Z',
              status: 'finished',
              updated_on: '2018-04-08T12:48:28Z',
              weight: 95
            },
            '/State5/State1': {
              description: 'Convert disks',
              message: 'State1 is finished.',
              percent: 100.0,
              started_on: '2018-04-08T12:35:24Z',
              status: 'finished',
              updated_on: '2018-04-08T12:36:16Z',
              weight: 1
            }
          }
        },
        ...
        src_id: '3',
        transformation_host_id: '1',
        transformation_host_name: 'rhvh02.example.com',
        virtv2v_disks: [
          {
            path: '[NFS_Datastore] test_migration/test_migration.vmdk',
            percent: 50,
        ...
        virtv2v_started_on: '2018-04-08 08:35:45',
        virtv2v_status: 'active',
        virtv2v_wrapper: {
          state_file: '/tmp/v2v-import-20180406T083602-116599.state',
          v2v_log: '/var/log/vdsm/import/v2v-import-20180406T083602-116599.log',
      ...
      phase_context: {},
      request_type: 'transformation_plan',
      source_id: '27', // This is the id of the VM.
      source_type: 'VmOrTemplate',
      state: 'active',
      status: 'Ok',
      tenant_id: '1',
      type: 'ServiceTemplateTransformationPlanTask',
      updated_on: '2018-04-08T12:49:30Z',
      userid: 'admin'
    }
  ],
  actions: [
