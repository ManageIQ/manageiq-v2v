...
import { migrationStatusMessage, V2V_DOWNLOAD_LOG_STATUS_MESSAGES, V2V_BACKEND_ERROR_MESSAGES } from './PlanConstants';
...
const processVMTasks = vmTasks => {
  ...
  vmTasks.forEach(task => {
    const taskDetails = {
      id: task.id,
      message: migrationStatusMessage(task.message),
